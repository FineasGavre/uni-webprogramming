...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO ubbdb.files (genre_id, title, format, file_path) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("isss", $genre, $title, $format, $file_path);
    $result = $stmt->execute();
    ...
    <head>
        ...
        <title>Create File - Multimedia File Manager</title>
    ...
    <script src="/assets/scripts/create_files.js"></script>
    </body>
    </html>
    <?php
}
